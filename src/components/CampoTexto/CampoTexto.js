...
const CampoTexto = (props) => {
    ...
    return <div className="campo-texto">
        ...
        <input placeholder={modificarPlaceholder} required ={props.required} ></input> {/* Aqui lo que hacemos es llamar una variable ara de esa modificar el plceholder cuado sea y la prop
